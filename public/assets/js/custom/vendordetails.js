...
var currentEngagementTable = function() {
    // Private functions
...
var issueTrackerTable = function() {
    // Private functions
    ...
    var initTable = function(e){
        ...
        $.ajax({
            ...
            type : 'GET',
            url : './getdatavendorissuelist/' + vendorId,
            datatType : 'JSON',
            success : function(data){
                var datatable = $('#issue_tracker_table').KTDatatable({
                    // datasource definition
                    data: {
                        type: 'local',
                        source: data,
...
jQuery(document).ready(function() {
    currentEngagementTable.init();
    issueTrackerTable.init();
});